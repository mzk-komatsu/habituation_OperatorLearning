...
Implementation of our paper, *""Data-driven modeling of habituation with its frequency-dependent hallmark based on Fourier Neural Operator.* (Nonlinear Theory and Its Applications, IEICE (NOLTA), in press.)
